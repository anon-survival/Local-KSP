...
parser.add_argument('--N', type=int, default=10000, help='number of train samples')
...
if args.dist == 'lognormal': 
    ...
    torch.save(loc_tr, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_loc_tr.pt')
    torch.save(scale_tr, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_scale_tr.pt')
    torch.save(loc_va, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_loc_va.pt')
    torch.save(scale_va, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_scale_va.pt')
    torch.save(loc_te, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_loc_te.pt')
    torch.save(scale_te, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_scale_te.pt')
...
torch.save(wsurv, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_wsurv.pt')
torch.save(bsurv, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_bsurv.pt')
torch.save(wcens, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_wcens.pt')
torch.save(bcens, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_bcens.pt')

# data
torch.save(x_tr, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_x_tr.pt')
torch.save(x_va, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_x_va.pt')
torch.save(x_te, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_x_te.pt')
torch.save(surv_t_tr, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_surv_t_tr.pt')
torch.save(surv_t_va, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_surv_t_va.pt')
torch.save(surv_t_te, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_surv_t_te.pt')
torch.save(censor_t_tr, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_censor_t_tr.pt')
torch.save(censor_t_va, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_censor_t_va.pt')
torch.save(censor_t_te, './data/lognormal/n_100000/' + str(args.set) + '/' + args.dist + '_censor_t_te.pt')
