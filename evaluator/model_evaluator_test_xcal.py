    ...
    def _eval_phase(self, model, data_loader, phase, device):
        ...
        if self.args.postprocessing:
            ...
            if phase == 'test':
                ...
                sheet.cell(row=last_row+1, column=1, value=KS_post[0].item())
                sheet.cell(row=last_row+1, column=2, value=KS_post[1].item())
                sheet.cell(row=last_row+1, column=3, value=KS_post[2].item())
                sheet.cell(row=last_row+1, column=4, value=KS_post[3].item())
                sheet.cell(row=last_row+1, column=5, value=KS_post[4].item())
                sheet.cell(row=last_row+1, column=6, value=KS_post[5].item())
                sheet.cell(row=last_row+1, column=7, value=(f'{self.args.model_dist}_{self.args.dataset}_xcal_lam_{self.args.lam}'))
            ...
            if phase == 'test':
                ...
                sheet.cell(row=last_row+1, column=2, value=metrics[phase + '_' + 'concordance'].item())
                sheet.cell(row=last_row+1, column=3, value=metrics[phase + '_' + 'S-cal(20)'].item())
                sheet.cell(row=last_row+1, column=4, value=metrics[phase + '_' + 'D-cal(20)'].item())
                sheet.cell(row=last_row+1, column=5, value=metrics[phase + '_' + 'KS'].item())
                sheet.cell(row=last_row+1, column=6, value=metrics[phase + '_' + 'KM-cal'].item())
                sheet.cell(row=last_row+1, column=7, value=metrics[phase + '_' + 'IBS'].item())
                sheet.cell(row=last_row+1, column=8, value=(f'{self.args.model_dist}_{self.args.dataset}_xcal_lam_{self.args.lam}'))
                workbook.save('./tmp2.xlsx')
